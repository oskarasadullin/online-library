...
import { ToastProvider } from './components/ToastContainer'; // ✅ НОВОЕ
...
function App() {
    return (
        <ThemeProvider>
            <AuthProvider>
                <ToastProvider> {/* ✅ ОБЕРНУЛИ В ToastProvider */}
                    <Router>
                        <div className="app">
                            ...
                            <main className="main-content">
                                <Routes>
                                    ...
                                    {/* ✅ НОВЫЙ РОУТ - ПОЛНОЭКРАННЫЙ РИДЕР */}
                                    ...
                                    {/* ✅ НОВЫЙ РОУТ - МОДЕРАЦИЯ (для админов) */}
